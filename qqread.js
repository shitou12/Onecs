...
const cookiesArr = [
  ...
  },
  {
    qqreadheaderVal: JSON.stringify({
      ...
      Cookie:
        "ywguid=1499399062;ywkey=ywMJ8n8iEr3y;platform=ios;channel=mqqmina;mpVersion=0.29.4",
      Connection: "keep-alive",
      "Content-Type": "application/json",
      Accept: "*/*",
      Host: "mqqapi.reader.qq.com",
    ...
    qqreadtimeheaderVal: JSON.stringify({
      ywsession: "hf2t7p6inx8bfzd970v42l2m3yxgm5n8",
      Cookie:
        "ywguid=1499399062;ywkey=ywMJ8n8iEr3y;platform=ios;channel=mqqmina;mpVersion=0.29.4;qq_ver=8.4.17;os_ver=iOS 13.3;mpos_ver=1.21.0;platform=ios;openid=C1C065D4B40C71B3096EE3E481A2C912",
      Connection: "keep-alive",
      "Content-Type": "application/json",
      Accept: "*/*",
      Host: "mqqapi.reader.qq.com",
  ...
  },
  {
    ...
    qqreadtimeurlVal:
      "https://mqqapi.reader.qq.com/mqq/addReadTimeWithBid?scene=1007&refer=-1&bid=26878703&readTime=2977&read_type=0&conttype=1&read_status=0&chapter_info=%5B%7B%221%22%3A%7B%22readTime%22%3A2977%2C%22pay_status%22%3A0%2C%22is_tail%22%3A0%7D%7D%5D&sp=-1",
    qqreadtimeheaderVal: JSON.stringify({
      ...
      Host: "mqqapi.reader.qq.com",
      "User-Agent": "QQ/8.4.17.638 CFNetwork/1121.2.2 Darwin/19.2.0",
      Referer: "hhttps://appservice.qq.com/1110657249/0.29.4/page-frame.html",
      "Accept-Language": "zh-cn",
      "Accept-Encoding": "gzip, deflate, br",
      mpversion: "0.29.4",
            }),
  ...
  {
    qqreadheaderVal: JSON.stringify({
      ywsession: "acurblwvjtls8uqtdklbv8csiyc4665n",
      Cookie:
        "ywguid=893420348;ywkey=ywKCegh6io8s;platform=ios;channel=mqqmina;mpVersion=0.29.4",
      Connection: "keep-alive",
      "Content-Type": "application/json",
      Accept: "*/*",
      Host: "mqqapi.reader.qq.com",
    ...
    qqreadtimeurlVal:
      "https://mqqapi.reader.qq.com/mqq/addReadTimeWithBid?scene=1007&refer=-1&bid=26134185&readTime=9456&read_type=0&conttype=1&read_status=0&chapter_info=%5B%7B%221%22%3A%7B%22readTime%22%3A9456%2C%22pay_status%22%3A0%7D%7D%5D&sp=-1",
    qqreadtimeheaderVal: JSON.stringify({
      ywsession: "acurblwvjtls8uqtdklbv8csiyc4665n",
      Cookie:
        "ywguid=893420348;ywkey=ywKCegh6io8s;platform=ios;channel=mqqmina;mpVersion=0.29.4;qq_ver=8.4.17;os_ver=iOS 13.3;mpos_ver=1.21.0;platform=ios;openid=1AB1F01CCE07AF6FEF507830AD00CD38",
      Connection: "keep-alive",
      "Content-Type": "application/json",
      Accept: "*/*",
      Host: "mqqapi.reader.qq.com",
...
function showmsg() {
  ...
  //宝箱领取成功通知
    ...
    if (isSend) notify.sendNotify(jsname, tz);
    tz="";
}
